...
describe('reduces the given list from the left with a function', () => {
  test('empty list', () => {
    const list1 = new List();
    expect(list1.reduce((acc, el) => el * acc, 2)).toEqual(2);
  });

  test('direction independent function applied to non-empty list', () => {
    const list1 = new List([1, 2, 3, 4]);
    expect(list1.reduce((acc, el) => acc + el, 5)).toEqual(15);
  });

  test('direction dependent function applied to non-empty list', () => {
    const list1 = new List([1, 2, 3, 4]);
    expect(list1.reduce((acc, el) => el / acc, 24)).toEqual(64);
  });
});

describe('reduces the given list from the right with a function', () => {
  test('empty list', () => {
    const list1 = new List();
    expect(list1.reduceFromRight((acc, el) => el * acc, 2)).toEqual(2);
  });

  test('direction independent function applied to non-empty list', () => {
    const list1 = new List([1, 2, 3, 4]);
    expect(list1.reduceFromRight((acc, el) => acc + el, 5)).toEqual(15);
  });

  test('direction dependent function applied to non-empty list', () => {
    const list1 = new List([1, 2, 3, 4]);
    expect(list1.reduceFromRight((acc, el) => el / acc, 24)).toEqual(9);
  });
});
